...
public class Weed extends AnimationObject {
	 ...
	 *
	 * @param ocean
	 *            The ocean to exist in.
	 * @param images
	 *            The images to loop through.
	 * @param x
	 *            The x coordinate of the weed.
	 * @param sleep
	 *            Number of ticks to wait before the next image is displayed.
	 */
	...
	/**
	 * Animate weed. Never request to be deleted.
	 *
	 * @return Always false.
	 */
	public void tick() {
	...
	public void paint(Graphics g) {
		g.drawImage(imageData.getAllImages()[frame], x,
				ocean.getHeightInPixels() - ocean.getFishHeight() - ocean.getGroundHeight() / 2, null);
	}
