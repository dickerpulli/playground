...
public class Submarine extends AnimationObject {
	...
	/**
	 * Create submarine with the given image, start coordinate, amplitude, wavelength (of the motion) and speed. The
	 * submarine enters the screen on the right hand side.
	 *
	 * @param ocean
	 *            Ocean the submarine has to move in.
	 * @param image
	 *            Image to be drawn.
	 * @param y
	 *            Initial y coordinate.
	 * @param amplitude
	 *            Amplitude of the sinus motion.
	 * @param wavlength
	 *            Wave length of the sinus motion.
	 * @param speed
	 *            Speed (x direction) of the submarine.
	 */
	public Submarine(OceanCanvas ocean, ImageData imageData, int y, int amplitude, double waveLenght, double speed) {
		super(ocean);
	...
	/**
	 * Move a submarine a little bit. Request deletion when it reaches the left hand side of the screen.
	 *
