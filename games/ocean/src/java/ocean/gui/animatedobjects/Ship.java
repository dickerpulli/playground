...
public class Ship extends AnimationObject {
	...
	/**
	 * Create a ship with the given animation frames and speed. The ship enters the screen on the left hand side.
	 *
	 * @param ocean
	 *            The ocean to sail.
	 * @param images
	...
	/**
	 * Move and animate the ship. Request deletion when the right hand side of the screen has been reached.
	 *
