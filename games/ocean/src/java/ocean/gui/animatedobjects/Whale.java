...
public class Whale extends AnimationObject {
	...
	/**
	 * Create whale with the given images, start coordinate, amplitude, wavelength (of the motion) and speed. The whale
	 * enters the screen on the right hand side.
	 *
	 * @param ocean
	 ...
	 */
	public Whale(OceanCanvas ocean, ImageData imageData, int y, int amplitude, double waveLenght, double speed) {
		super(ocean);
	...
	/**
	 * Move a whale a little bit. Request deletion when it reaches the left hand side of the screen.
	 *
