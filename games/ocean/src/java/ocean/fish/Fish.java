...
public abstract class Fish
{
	...
	/**
	 * The strategy method: Returns the direction of this
	 * fish in the next step, based on the given matrix.
	 * It should not change the matrix!
	 *
	 * @param from The current coordinate of this fish
	 * @param matrix The FishMatrix to be examined.
	 * 
	 ...
	 * @param matrix The FishMatrix, which may also be changed in this method.
